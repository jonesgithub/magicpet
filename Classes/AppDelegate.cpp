...
AppDelegate::~AppDelegate()
{
	...
	CC_SAFE_DELETE( g_pClientLoader );
	CSqliteManager::GetInstance()->Release();
}
...
bool AppDelegate::initInstance() 
{
    ...
    do 
    {
        ...
        CC_BREAK_IF(! pMainWnd
            || ! pMainWnd->Create(TEXT("MagicPet"), 320, 480));
        ...
        CCFileUtils::setResource("MagicPet.zip");
#endif
...
pDirector->enableRetinaDisplay( true );
    ...
    CCScene *pScene = CGameLogo::scene();
